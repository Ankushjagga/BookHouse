  ...
  export  const items = [
    ...
    "description" : "Lightweight yet durable backpack/daypack for school use or everyday outingsFront storage pocket keeps smaller items neatly organized and easy to access Mesh pockets on both sides to accommodate your water bottle and umbrella Mesh Padding on back & shoulder strap to provide comfort & better back support; 1-year International Warranty against manufacturing defects",
    "category": "Bags",
    "image":"safari.jpg",
    "features": [
      "Colour: Teal ",
    ...
    "Size: 35 x 13 x 46 cms"
          ...
          "amount":1
            ...
            "_id": "03",
                ...
                "Closure Type: Zipper",
                  "Lining Description: Polyester",
                 " Easy grab padded handle: For added comfort and convinience to hold the bag",
    ...
    "amount":1   
        ...
        },
        {
          ...
          "description" : "Sharpner Scientifically angled blade for easy sharpening Anti-rust coating for long lasting blade edge Vibrant colours for joyful erasing Doesn’t leave a trace of colour while erasing Available in 5 attractive & fluorescent colours.",
          "category": "Stationary",
          "image": "eraser.jpg",
          "features":[
        "Product 1: Sharpner",
    ...
    "amount":1    
        ...
        },
        {
          ...
          "description" : " A comprehensive combination kit to satisfy your kids' creative needs.It is a well curated kit which includes a wide range of products required by your creative child.Attratctive packing which serves as a great gifting option.The contents of the kit lies solely within the discretion of the brand and actual products may vary. Product Image is indicative.",
          "category": "Stationary",
          ...
          "features":[
            ...
            "Brand :	Doms",
            "Product : Smart Kit",
    "Item Dimensions : LxWxH	34 x 25 x 5 Centimeters",
    "Material : Paper",
    "Seasons : All Seasons",
          ],
    "price": "500"  ,
    ...
    "Rule Type : ONE SIDE"
      ...
      },
      {
        ...
        "name":"Apsara Platinum Extra Dark Pencil","description":"Apsara Pencil is one of the most basic stationery items needed in every stationary kit for a student and in homes and offices. It is used for writing notes, drawing and marking layouts. Pencil written texts can easily be erased using an eraser, making it extremely useful while sketching and drawing.","features":["  Brand : Apsara "," Item Dimensions LxWxH : 20 x 10 x 5 Centimeters","  Line Size : 0.3mm","  Item Weight : 800 Grams","  Efficient usage"],"category":"Pencil","image":"apsra.jpg","price":"100",
        "amount":1}
